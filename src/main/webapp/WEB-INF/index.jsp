	...
	<div class="membership-list">
		...
		<c:if test="${list.size() != 0}">			
			...
			<div class="membership-card">
				<c:if
					test="${info.membershipDate >  today30 && today > info.membershipDate}">
					<img alt="" src="http://192.168.10.51:8081/sungil/2%ED%8A%B8.png"
						class="new">
				</c:if>
					...
					<a href="/userInfo/${info.nickname}">
						<div class="host">
							...
							<div class="memberMannerIndex">
								...
								<c:if
									test="${info.memberManner >= 30 && info.memberManner <= 40}">
									<span style="color: rgb(252, 177, 3)"><i
