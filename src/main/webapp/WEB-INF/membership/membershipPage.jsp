...
<body>
	...
	<div id="main-container">
			...
			<div class="accordion-item">
				...
				<div id="collapseOne" class="accordion-collapse collapse "
					...
					<div class="accordion-body">
						...
						<c:forEach items="${allMember}" var="listMember" varStatus="num">
							...
							<div class="memberTable">
								<ul>
									<div class="member-img-icon-nickname-manner">
										<div class="member-img-icon">
											...
											<div class="member-img">
												<c:if test="${listMember.member.memberImg != null}">
													<li><c:if test="${num.first}">
															<a href="/mypage"><img class="allmemberImg"
																src="http://192.168.10.51:8081/member/${listMember.member.id}/${listMember.member.memberImg}"
																alt="회원 이미지"></a>
														</c:if> <c:if test="${!num.first}">

															<a href="/userInfo/${listMember.member.nickname}"><img
																class="allmemberImg"
																src="http://192.168.10.51:8081/member/${listMember.member.id}/${listMember.member.memberImg}"
																alt="회원 이미지"></a>
														</c:if></li>
												...
												<li><c:if test="${num.first}">
														<a href="/mypage"> <c:if
																test="${listMember.member.memberImg == null}">
														...
														<a href="/userInfo/${listMember.member.nickname}"> <c:if
																test="${listMember.member.memberImg == null}">
																<img class="allmemberImg"
																	src="http://192.168.10.51:8081/%EA%B8%B0%EB%B3%B8%ED%94%84%EC%82%AC.jpg"
																	alt="회원 이미지">
										...
										<!-- <a href="/userInfo/${listMember.member.nickname}"></a> -->
		...
		<div id="container">
			...
			<div class="lostDance">
				<button class="lostBtn">펼치기</button>
				<div class="lostDiv" id="info-container">${main.membership.membershipInfo }</div>
			</div>
