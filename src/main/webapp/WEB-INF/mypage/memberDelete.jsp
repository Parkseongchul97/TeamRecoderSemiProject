      ...
      <div class="container">
        ...
        <section class="warning">
          <div>
            ...
            <ul>
              <li>
                사용하고 계신 아이디 <strong>( ${member.id} ) </strong>은/는
        ...
        <section class="post-retention">
          <div>
            <h2>※ 주의사항 ※</h2>
            <p>
              탈퇴 후에도 게시판 서비스에 등록한 게시물은 그대로 남아 있습니다.
              <strong
                >가입한 클럽에 올린 게시글 및 댓글은 탈퇴 시 자동 삭제되지 않고
                그대로 남아 있습니다.</strong
              >
              삭제를 원하는 게시글이 있다면 반드시
              <strong>탈퇴 전 비공개 처리하거나 삭제하시기 바랍니다.</strong>
            ...
            <p>
              탈퇴 후에는
              <strong
                >해당 아이디 로 다시 가입할 수 없으며 아이디와 데이터는 복구할
                수 없습니다.</strong
              >
