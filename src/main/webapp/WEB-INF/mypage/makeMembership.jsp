	...
	<sec:authorize access="isAuthenticated()" var="principal">
		...
		<form enctype="multipart/form-data">
			...
			<label for="membershipName"> 클럽이름 : <span class="name"
				...
				name="membershipName" maxlength="50"> 사진첨부: <input
				type="file" name="file" id="file" accept="image/*"> 클럽 가입조건
			: <input type="text" id="membershipAccessionText"
				name="membershipAccessionText"> 클럽 간단한 설명:<input type="text"
				id="membershipSimpleText" name="membershipSimpleText"> 최대 인원
			: <span class="max" id="max"></span> <input type="number"
			...
			<div class="container">
				...
				<input type="button" value="추가" id="locationBtn"> <input
					type="button" value="취소" id="locationBtncancel">
				<p>유형</p>
				...
				<input type="button" value="추가" id="typeBtn"> <input
					type="button" value="취소" id="typeBtncancel">
